        ...
        <div class="box-body">
          ...
          <table class="table table-condensed">
            ...
            <tr>
              ...
              <td>
                <b>{!! Form::label('subscribe_status',Lang::get('message.subscribe_status'),['class'=>'required']) !!}</b>
              </td>
              <td>
              ...
              <tr>
                ...
                <td>
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <a href="{{url('mail-chimp/mapping')}}"
                         class="btn btn-primary">{{Lang::get('message.mapping')}}</a>
