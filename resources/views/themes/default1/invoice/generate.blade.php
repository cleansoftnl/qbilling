...
@section('content')
  <link href="{!!asset('plugins/dhtmlxSuite_v50_std/codebase/fonts/font_roboto/roboto.css')!!}" rel="stylesheet"
        type="text/css"/>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-6 form-group">
            ...
            <p>{!! Form::checkbox('client',1) !!} To
              Client&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{!! Form::checkbox('agent',1) !!} To Agent</p>
          </div>
