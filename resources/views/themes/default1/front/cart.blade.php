                          ...
                          <table class="shop_table cart">
                            ...
                            @forelse($cartCollection as $key=>$item)
                              ...
                              <tr class="cart_table_item">
                                ...
                                <td class="product-price">
                                  <span class="amount"><small>{!! $symbol !!}
                                      &nbsp;</small>{{\App\Http\Controllers\Front\CartController::calculateTax($item->id,$item->price,1,1,0)}}</span>
                                </td>
                                <td class="product-quantity">
                                  @if($multi_product==true)

                                    <input type="number" title="Qty" value="{{$item->quantity}}" name="quantity"
                                           id="quantity" min="1" step="1" style="width: 50%"
                                ...
                                <td class="product-subtotal">
                                  <span class="amount"><small>{!! $symbol !!}
                                      &nbsp;</small>{{\App\Http\Controllers\Front\CartController::calculateTax($item->id,$item->getPriceSum(),1,1,0)}}</span>
                                </td>
                      ...
                      @foreach($addons as $addon)
                        <div class="col-md-3">
                          <div class="featured-box featured-box-primary">
                            <div class="box-content">
                              <span><img width="50" height="50" alt="" class="img-responsive"
                                         src="{{$addon->image}}"></span>
                              <span>{{ucfirst($addon->name)}}</span>
                              <span><a href="{{$addon->shoping_cart_link}}"
                                       class="btn btn-small btn-primary">Buy</a></span>
                            </div>
                          </div>
                        </div>
                      @endforeach
                ...
                <div class="featured-box featured-box-primary align-left mt-sm">
                  <div class="box-content">
                    ...
                    <table class="cart-totals">
                      ...
                      <tr class="total">
                        ...
                        <td>
                          <strong><span class="amount"><small>{!! $symbol !!}
                                &nbsp;</small>{{App\Http\Controllers\Front\CartController::rounding(Cart::getSubTotal())}}</span></strong>
                        </td>
                      </tr>
                  ...
                  <div class=" col-md-6"><br><br><br><br>
                    <a href="{{url('cart/clear')}}">
                      <button class="btn btn-danger btn-lg">Clear My Cart<i class="fa fa-angle-right ml-xs"></i>
                      </button>
                    </a>
                  </div>
                  <div class="col-md-6"><br><br><br><br>
                    ...
                    @if(count($domain)>0)
                      ...
                      <a href="#domain" data-toggle="modal" data-target="#domain">
                        <button class="btn btn-primary btn-lg">Proceed to Checkout<i
