            ...
            <div class="col-md-12">
              ...
              <div class="col-md-6">
                ...
                <table class="table table-hover">
                  ...
                  <tr>
                    <td><b>Name:</b></td>
                    <td><a href="{{url('clients/'.$user->id)}}">{{ucfirst($user->first_name)}}</a></td>
                  </tr>
                  <tr>
                    <td><b>Email:</b></td>
                    <td>{{$user->email}}</td>
                  ...
                  <tr>
                    <td><b>Mobile:</b></td>
                    <td>@if($user->mobile_code)<b>+</b>{{$user->mobile_code}}@endif{{$user->mobile}}</td>
                  </tr>
                  <tr>
                    <td><b>Address:</b></td>
                    <td>{{$user->address}},
                  ...
                  <tr>
                    <td><b>Country:</b></td>
                    <td>{{\App\Http\Controllers\Front\CartController::getCountryByCode($user->country)}}</td>
                  </tr>
              ...
              <div class="col-md-6">
                ...
                <table class="table table-hover">
                  ...
                  <tr>
                    ...
                    <td>{{$order->serial_key}}</td>
                  </tr>
                  <tr>
                    <td><b>Domain Name:</b></td>
                    <td contenteditable="true" id="domain">{{$order->domain}}</td>
                  </tr>
                  <?php
                  $sub = "--";
                  if ($subscription) {
