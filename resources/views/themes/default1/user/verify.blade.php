            ...
            <div class="header-logo">
              <a href="{{url('home')}}">
                <img alt="Porto" width="111" height="54" data-sticky-width="82" data-sticky-height="40"
                     data-sticky-top="33" src="{{asset('cart/img/logo/'.$setting -> logo)}}">
              </a>
            </div>
          </div>
      ...
      @if ($user->active != 1)
        <h1>Email Verification</h2>
          ...
          <div class="row" style="margin-bottom: 10px">
            <div class="col-sm-4" style="margin: 5px"><input type="text" class="form-control" name="email"
                                                             value="{{$user -> email}}" id="u_email"></div>
            <div class="col-sm-4" style="margin: 5px">
              <button class="btn btn-info" ng-click="sendEmail()">Verify Email</button>
            </div>
          </div>
          @endif
          @if($user->mobile_verified!=1)
            <h1>Mobile Verification</h2>
              ...
              <div class="row" ng-hide="showOTP" style="margin-bottom: 10px">
                <div class="col-sm-1" style="margin: 5px"><input type="text" class="form-control" name="code"
                                                                 value="{{$user -> mobile_code}}" id="u_code"></div>
                <div class="col-sm-4" style="margin: 5px"><input type="text" class="form-control" name="mobile"
                                                                 value="{{$user -> mobile}}" id="u_mobile"></div>
                <div class="col-sm-4" style="margin: 5px">
                  <button class="btn btn-info" ng-click="sendOTP()">Send OTP</button>
                </div>
              </div>
              <div class="row" ng-show="showOTP">
                ...
                <div class="col-sm-4" style="margin: 5px">
                  <button class="btn btn-info" ng-click="submitOTP(otp)">Verify OTP</button>
                  <a ng-click="resendOTP()" style="margin-left: 5px;line-height: 2.5;cursor: pointer">Resend OTP</a>
                </div>
              </div>
              @endif
              @endif
  ...
  <footer id="footer">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-2">
          <a href="#"
             onclick="window.open('https://www.sitelock.com/verify.php?site=faveohelpdesk.com', 'SiteLock', 'width=600,height=600,left=160,top=170');"><img
              class="img-responsive" alt="SiteLock" title="SiteLock"
              src="//shield.sitelock.com/shield/faveohelpdesk.com"/></a>
        </div>
    ...
    <div class="footer-copyright">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12">
            <p>Copyright © <?php echo date('Y') ?> · <a href="{{$set -> website}}"
                                                        target="_blank">{{$set -> company}}</a>. All Rights
              Reserved.Powered by
              <a href="http://www.ladybirdweb.com/" target="_blank"><img src="{{asset('dist/img/Ladybird1.png')}}"
                                                                         alt="Ladybird"></a></p>
          </div>
