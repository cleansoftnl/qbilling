              ...
              <div class="header-nav">
                ...
                <ul class="header-social-icons social-icons hidden-xs">
                  ...
                  @foreach($social as $media)
                    <li class="{{$media->class}}"><a href="{{$media->link}}" target="_blank"
                                                     title="{{ucfirst($media->name)}}"><i
                          class="{{$media->fa_class}}"></i></a></li>
                  @endforeach
                </ul>
                                ...
                                <table class="cart">
                                  ...
                                  <tr>
                                    ...
                                    <td class="product-thumbnail">
                                      <img width="100" height="100" alt="{{$product->name}}" class="img-responsive"
                                           src="{{$product->image}}">
                                    </td>

                                    <td class="product-name">
                                      <a>{{$item->name}}<br><span class="amount"><strong>
                                            <small>{{$currency}}</small> {{App\Http\Controllers\Front\CartController::rounding($item->getPriceSumWithConditions())}}
                                          </strong></span></a>
                                    </td>
                                      ...
                                      <td class="actions" colspan="6">
                                        <div class="actions-continue">
                                          <a href="{{url('show/cart')}}">
                                            <button class="btn btn-primary pull-left">View Cart</button>
                                          </a>

                                          @if(count($domain)>0)
                                            <button class="btn btn-primary pull-right"><a href="#domain"
                                                                                          data-toggle="modal"
                                                                                          data-target="#domain">Proceed
                                                to Checkout</a></button>

                                          @else
                                            <button class="btn btn-primary pull-right"><a href="{{url('checkout')}}">Proceed
                                                to Checkout</a></button>
                                          @endif
                                        </div>
                                      </td>
    ...
    <div class="footer-copyright">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12">
            <p>Copyright © <?php echo date('Y') ?> · <a href="{{$set->website}}" target="_blank">{{$set->company}}</a>.
